...
def main(args):
    ...
    snapshot_val_pred = np.round(np.concatenate(snapshot.all_snapshots, axis=-1).mean(-1))
    ...
    print ("Snapshot scores: F1 {}, Precision {} and Recall {}".format(f1_snapshot, precision_snapshot, recall_snapshot))
